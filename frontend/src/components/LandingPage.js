...
import { weatherForecast, features, testimonials, riskZones, stats } from '../mock';
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Météo Sentinelle combine données météorologiques, intelligence artificielle et 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Météo détaillée avec indicateurs de risque pour les 5 prochains jours
            </p>
          </div>
                ...
                <Card key={day.id} className="weather-card p-4">
                  <CardContent className="text-center space-y-3">
                    ...
                    <Badge 
                      ...
                      style={{ backgroundColor: day.riskColor + '20', color: day.riskColor }}
                    >
                      Risque {day.riskLevel}
                    </Badge>
                    <div className="text-xs text-gray-500 space-y-1">
                      <div>Vent: {day.windSpeed} km/h</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Carte des risques en temps réel
            </h2>
            <p className="text-lg text-gray-600">
              Visualisez les zones à risque et suivez l'évolution météorologique
            </p>
          </div>
          ...
          <div className="map-container rounded-lg h-96 flex items-center justify-center relative">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Visualisation des données météo en temps réel sur toute la Guadeloupe
              </p>
              <div className="flex flex-wrap gap-3 justify-center">
                {riskZones.map((zone, index) => (
                  <div key={index} className="flex items-center bg-white rounded-full px-3 py-1 shadow-sm">
                    ...
                    <Badge 
                      className={`risk-indicator risk-${zone.riskLevel} ml-2`}
                      variant="outline"
                    >
                      {zone.riskLevel}
                    </Badge>
      ...
      <section id="contact" className="cta-gradient text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Soyez parmi les premiers à bénéficier de notre service d'alerte météo nouvelle génération
          </p>
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              ...
              >
                {isSubmitting ? 'Envoi...' : 'Demander un accès'}
              </Button>
            </div>
            <Textarea
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                Protection météorologique avancée pour la Guadeloupe et les Antilles.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><a href="#" className="hover:text-white">Cartes interactives</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Météo Sentinelle. Tous droits réservés.
            </p>
